...
- **Acceptance Criteria**:
  - [x] Match Hub displays live match details and past score history.
  - [x] Smart Ticket Card displays assigned vs. AI-recommended entry gate.
  - [x] Staggered batch arrival slots are displayed and calculated.
  - [x] Active incidents at a gate automatically trigger redirection warnings.
- **Validation Result**: ✅ PASS
- **Chain-Prompt Iterations**: 0
